...
public class SwipeKey extends AbstractPredictiveKeyboardLayout {
    ...
    public static final int ALPHA = R.layout.swipekey_alpha;
    public static final int QWERTY = R.layout.swipekey_qwerty;


    public SwipeKey(Context context, int layout) {
